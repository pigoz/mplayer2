...
// The following is a workaround to avoid undefined symbols when building with
// llvm-gcc-4.2.x
#if defined(__APPLE__) && defined(__llvm__) && defined(__GNUC__) \
    && (__GNUC__ == 4 && __GNUC_MINOR__ == 2)
#define DECLARE_ASM_CONST_(n,t,v)   __private_extern__ const t av_used __attribute__ ((aligned (n))) v
#else
#define DECLARE_ASM_CONST_(n,t,v)   DECLARE_ASM_CONST(n,t,v)
#endif

#if HAVE_MMX

DECLARE_ASM_CONST_(8, uint64_t, MM_FIX_0_382683433)=FIX64(0.382683433, 14);
DECLARE_ASM_CONST_(8, uint64_t, MM_FIX_0_541196100)=FIX64(0.541196100, 14);
DECLARE_ASM_CONST_(8, uint64_t, MM_FIX_0_707106781)=FIX64(0.707106781, 14);
DECLARE_ASM_CONST_(8, uint64_t, MM_FIX_1_306562965)=FIX64(1.306562965, 14);

DECLARE_ASM_CONST_(8, uint64_t, MM_FIX_1_414213562_A)=FIX64(1.414213562, 14);

DECLARE_ASM_CONST_(8, uint64_t, MM_FIX_1_847759065)=FIX64(1.847759065, 13);
DECLARE_ASM_CONST_(8, uint64_t, MM_FIX_2_613125930)=FIX64(-2.613125930, 13); //-
DECLARE_ASM_CONST_(8, uint64_t, MM_FIX_1_414213562)=FIX64(1.414213562, 13);
DECLARE_ASM_CONST_(8, uint64_t, MM_FIX_1_082392200)=FIX64(1.082392200, 13);
//for t3,t5,t7 == 0 shortcut
DECLARE_ASM_CONST_(8, uint64_t, MM_FIX_0_847759065)=FIX64(0.847759065, 14);
DECLARE_ASM_CONST_(8, uint64_t, MM_FIX_0_566454497)=FIX64(0.566454497, 14);
DECLARE_ASM_CONST_(8, uint64_t, MM_FIX_0_198912367)=FIX64(0.198912367, 14);

DECLARE_ASM_CONST_(8, uint64_t, MM_DESCALE_RND)=C64(4);
DECLARE_ASM_CONST_(8, uint64_t, MM_2)=C64(2);
