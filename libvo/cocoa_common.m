...
void create_menu()
{
    ...
    NSMenu *main_menu, *p_menu, *m_menu, *a_menu, *w_menu;

    main_menu = [[NSMenu new] autorelease];
    p_menu = [[[NSMenu alloc] initWithTitle:@"mplayer2"] autorelease];
    new_main_menu_item(main_menu, p_menu, @"mplayer2");
    new_menu_item(p_menu, @"Quit mplayer2", @selector(quitPlayer:), @"q");
