...
static ssize_t mga_vid_read(struct file *file, char *buf, size_t count, int64_t *ppos)
{
    uint32_t size;
    mga_card_t * card = (mga_card_t *) file->private_data;
...
static ssize_t mga_vid_write(struct file *file, const char *buf, size_t count, int64_t *ppos)
{
    mga_card_t * card = (mga_card_t *) file->private_data;
